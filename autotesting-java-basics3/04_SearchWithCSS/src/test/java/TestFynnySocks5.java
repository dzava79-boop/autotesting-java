...
public class TestFynnySocks5 {
    ...
    public void Test1Entrance() {
        ...
        var email = By.cssSelector("input#email.form-input.input-data");
        var password = By.cssSelector("input#password.form-input.password");
        var button = By.cssSelector("button#submit.form-submit");
        driver.findElement(email).sendKeys("@");
        driver.findElement(password).sendKeys("123");
        driver.findElement(button).click();
        var error = driver.findElement(By.cssSelector("pre#error.form-error-password-email")).getText();
